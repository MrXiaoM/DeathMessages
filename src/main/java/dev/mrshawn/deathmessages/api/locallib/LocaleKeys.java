...
public class LocaleKeys {
    public static LinkedHashMap<String, String> getBlockKeys() {
        ...
        keys.put("RED_MUSHROOM", "tile.mushroom.name");
        ...
        keys.put("REDSTONE_TORCH_OFF", "tile.notGate.name");
        keys.put("STONE_BUTTON", "tile.button.name");
        keys.put("WOOD_BUTTON", "tile.button.name");
        keys.put("SNOW", "tile.snow.name");
        keys.put("SNOW_BLOCK", "tile.snow.name");
        ...
        keys.put("NETHER_WARTS", "tile.netherStalk.name");
        ...
        keys.put("REDSTONE_LAMP_ON", "tile.redstoneLight.name");
        ...
        keys.put("BED_BLOCK.15", "item.bed.black.name");
        keys.put("BED_BLOCK.14", "item.bed.red.name");
        keys.put("BED_BLOCK.13", "item.bed.green.name");
        keys.put("BED_BLOCK.12", "item.bed.brown.name");
        keys.put("BED_BLOCK.11", "item.bed.blue.name");
        keys.put("BED_BLOCK.10", "item.bed.purple.name");
        keys.put("BED_BLOCK.9", "item.bed.cyan.name");
        keys.put("BED_BLOCK.8", "item.bed.silver.name");
        keys.put("BED_BLOCK.7", "item.bed.gray.name");
        keys.put("BED_BLOCK.6", "item.bed.pink.name");
        keys.put("BED_BLOCK.5", "item.bed.lime.name");
        keys.put("BED_BLOCK.4", "item.bed.yellow.name");
        keys.put("BED_BLOCK.3", "item.bed.lightBlue.name");
        keys.put("BED_BLOCK.2", "item.bed.magenta.name");
        keys.put("BED_BLOCK.1", "item.bed.orange.name");
        keys.put("BED_BLOCK.0", "item.bed.white.name");
        keys.put("BED_BLOCK", "item.bed.name");
        keys.put("DIODE_BLOCK_OFF", "item.diode.name");
        keys.put("DIODE_BLOCK_ON", "item.diode.name");
        keys.put("REDSTONE_COMPARATOR_OFF", "item.comparator.name");
        keys.put("REDSTONE_COMPARATOR_ON", "item.comparator.name");
        keys.put("SKULL.0", "item.skull.skeleton.name");
        keys.put("SKULL.1", "item.skull.wither.name");
        keys.put("SKULL.2", "item.skull.zombie.name");
        keys.put("SKULL.3", "item.skull.char.name");
        keys.put("SKULL.4", "item.skull.player.name");
        keys.put("SKULL.5", "item.skull.creeper.name");
        keys.put("SKULL.6", "item.skull.dragon.name");
        return keys;
    }
    ...
    public static LinkedHashMap<String, String> getItemKeys() {
        ...
        keys.put("BED.15", "item.bed.black.name");
        keys.put("BED.14", "item.bed.red.name");
        keys.put("BED.13", "item.bed.green.name");
        keys.put("BED.12", "item.bed.brown.name");
        keys.put("BED.11", "item.bed.blue.name");
        keys.put("BED.10", "item.bed.purple.name");
        keys.put("BED.9", "item.bed.cyan.name");
        keys.put("BED.8", "item.bed.silver.name");
        keys.put("BED.7", "item.bed.gray.name");
        keys.put("BED.6", "item.bed.pink.name");
        keys.put("BED.5", "item.bed.lime.name");
        keys.put("BED.4", "item.bed.yellow.name");
        keys.put("BED.3", "item.bed.lightBlue.name");
        keys.put("BED.2", "item.bed.magenta.name");
        keys.put("BED.1", "item.bed.orange.name");
        keys.put("BED.0", "item.bed.white.name");
        ...
        keys.put("LEAVES_2", "item.leaves.name");
        ...
        keys.put("STANDING_BANNER.15", "item.STANDING_BANNER.black.name");
        keys.put("STANDING_BANNER.14", "item.STANDING_BANNER.red.name");
        keys.put("STANDING_BANNER.13", "item.STANDING_BANNER.green.name");
        keys.put("STANDING_BANNER.12", "item.STANDING_BANNER.brown.name");
        keys.put("STANDING_BANNER.11", "item.STANDING_BANNER.blue.name");
        keys.put("STANDING_BANNER.10", "item.STANDING_BANNER.purple.name");
        keys.put("STANDING_BANNER.9", "item.STANDING_BANNER.cyan.name");
        keys.put("STANDING_BANNER.8", "item.STANDING_BANNER.silver.name");
        keys.put("STANDING_BANNER.7", "item.STANDING_BANNER.gray.name");
        keys.put("STANDING_BANNER.6", "item.STANDING_BANNER.pink.name");
        keys.put("STANDING_BANNER.5", "item.STANDING_BANNER.lime.name");
        keys.put("STANDING_BANNER.4", "item.STANDING_BANNER.yellow.name");
        keys.put("STANDING_BANNER.3", "item.STANDING_BANNER.lightBlue.name");
        keys.put("STANDING_BANNER.2", "item.STANDING_BANNER.magenta.name");
        keys.put("STANDING_BANNER.1", "item.STANDING_BANNER.orange.name");
        keys.put("STANDING_BANNER.0", "item.STANDING_BANNER.white.name");
        keys.put("WALL_BANNER.15", "item.WALL_BANNER.black.name");
        keys.put("WALL_BANNER.14", "item.WALL_BANNER.red.name");
        keys.put("WALL_BANNER.13", "item.WALL_BANNER.green.name");
        keys.put("WALL_BANNER.12", "item.WALL_BANNER.brown.name");
        keys.put("WALL_BANNER.11", "item.WALL_BANNER.blue.name");
        keys.put("WALL_BANNER.10", "item.WALL_BANNER.purple.name");
        keys.put("WALL_BANNER.9", "item.WALL_BANNER.cyan.name");
        keys.put("WALL_BANNER.8", "item.WALL_BANNER.silver.name");
        keys.put("WALL_BANNER.7", "item.WALL_BANNER.gray.name");
        keys.put("WALL_BANNER.6", "item.WALL_BANNER.pink.name");
        keys.put("WALL_BANNER.5", "item.WALL_BANNER.lime.name");
        keys.put("WALL_BANNER.4", "item.WALL_BANNER.yellow.name");
        keys.put("WALL_BANNER.3", "item.WALL_BANNER.lightBlue.name");
        keys.put("WALL_BANNER.2", "item.WALL_BANNER.magenta.name");
        keys.put("WALL_BANNER.1", "item.WALL_BANNER.orange.name");
        keys.put("WALL_BANNER.0", "item.WALL_BANNER.white.name");
        return keys;
    }
    ...
    public static Map<String, String> getEntityKeys() {
        ...
        keys.put("ZOMBIE_VILLAGER", "entity.Villager.name");
        ...
        keys.put("RED_CAT", "entity.Cat.name");
        keys.put("SIAMESE_CAT", "entity.Cat.name");
        ...
        keys.put("LLAMA_SPIT", "entity.Llama.name");
        ...
        keys.put("MINECART_COMMAND", "item.minecartCommandBlock.name");
        keys.put("MINECART_FURNACE", "item.minecartFurnace.name");
        keys.put("MINECART_HOPPER", "item.minecartHopper.name");
        keys.put("MINECART_MOB_SPAWNER", "entity.Minecart.name");
        keys.put("MINECART_TNT", "item.minecartTnt.name");
        keys.put("BOAT", "entity.Boat.name");
        keys.put("UNKNOWN", "entity.generic.name");
        keys.put("SPECTRAL_ARROW", "item.spectral_arrow.name");
        keys.put("TIPPED_ARROW", "item.tipped_arrow.name");
        keys.put("ENDER_CRYSTAL", "item.end_crystal.name");
        keys.put("ENDER_PEARL", "item.enderPearl.name");
        keys.put("ENDER_SIGNAL", "item.end_crystal.name");
        keys.put("LEASH_HITCH", "item.leash.name");
        keys.put("ITEM_FRAME", "item.frame.name");
        keys.put("FISHING_HOOK", "item.fishingRod.name");
        keys.put("COMPLEX_PART", "entity.EnderDragon.name");
        return keys;
    }
}
